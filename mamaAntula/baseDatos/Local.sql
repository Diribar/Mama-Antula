...
CREATE TABLE `cont_2contenidos` (
	...
	PRIMARY KEY (`id`),
	KEY `contenido_encabezado` (`encab_id`),
	CONSTRAINT `contenido_encabezado` FOREIGN KEY (`encab_id`) REFERENCES `encab_1original` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cont_3carrusel` (
	...
	`statusRegistro_id` tinyint(1) unsigned NOT NULL DEFAULT 1,
	PRIMARY KEY (`id`),
	KEY `carrousel_contenido` (`contenido_id`),
	CONSTRAINT `carrousel_contenido` FOREIGN KEY (`contenido_id`) REFERENCES `cont_2contenidos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cont_ediciones` (
	...
	PRIMARY KEY (`id`),
	KEY `contEdiciones_contenido` (`contenido_id`) USING BTREE,
	KEY `contEdiciones_usuario` (`editadoPor_id`) USING BTREE,
	CONSTRAINT `contEdiciones_contenido` FOREIGN KEY (`contenido_id`) REFERENCES `cont_2contenidos` (`id`),
	CONSTRAINT `contEdiciones_usuario` FOREIGN KEY (`editadoPor_id`) REFERENCES `us_usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `encab_1original` (
	...
	`statusRegistro_id` tinyint(1) unsigned NOT NULL DEFAULT 1,
	PRIMARY KEY (`id`),
	KEY `encabezado_lugar` (`lugar_id`) USING BTREE,
	KEY `encabezado_codigoLugar` (`codigoLugar`),
	KEY `encabezado_usuario` (`creadoPor_id`) USING BTREE,
	KEY `encabezado_statusRegistro` (`statusRegistro_id`) USING BTREE,
	CONSTRAINT `encabezado_lugar` FOREIGN KEY (`lugar_id`) REFERENCES `aux_lugares` (`id`),
	CONSTRAINT `encabezado_codigoLugar` FOREIGN KEY (`codigoLugar`) REFERENCES `nivel9_indices_lugar` (`codigo`),
	CONSTRAINT `encabezado_usuario` FOREIGN KEY (`creadoPor_id`) REFERENCES `us_usuarios` (`id`),
	CONSTRAINT `encabezado_statusRegistro` FOREIGN KEY (`statusRegistro_id`) REFERENCES `aux_status_registros` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `encab_2edicion` (
	...
	`editadoEn` datetime NOT NULL DEFAULT utc_timestamp(),
	PRIMARY KEY (`id`),
	KEY `encabEdicion_encabezado` (`encab_id`),
	KEY `encabEdicion_sinindice` (`sinIndice_id`),
	KEY `encabEdicion_desdePersonaje` (`nombreDesde_id`) USING BTREE,
	KEY `encabEdicion_haciaPersonaje` (`nombreHacia_id`) USING BTREE,
	KEY `encabEdicion_idioma` (`idioma_id`) USING BTREE,
	KEY `encabEdicion_lugar` (`lugar_id`) USING BTREE,
	KEY `encabEdicion_usuario` (`editadoPor_id`) USING BTREE,
	CONSTRAINT `encabEdicion_encabezado` FOREIGN KEY (`encab_id`) REFERENCES `encab_1original` (`id`),
	CONSTRAINT `encabEdicion_usuario` FOREIGN KEY (`editadoPor_id`) REFERENCES `us_usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nivel2_temas` (
	...
	KEY `temas_seccion` (`seccion_id`),
	KEY `temas_capturadoPor` (`capturadoPor_id`),
	CONSTRAINT `temas_seccion` FOREIGN KEY (`seccion_id`) REFERENCES `nivel1_secciones` (`id`),
...
CREATE TABLE `nivel3_pestanas` (
	...
	PRIMARY KEY (`id`),
	UNIQUE KEY `codigo` (`codigo`),
	KEY `pestanas_tema` (`tema_id`),
	KEY `pestanas_capturadoPor` (`capturadoPor_id`),
	CONSTRAINT `pestanas_tema` FOREIGN KEY (`tema_id`) REFERENCES `nivel2_temas` (`id`),
...
CREATE TABLE `nivel9_indices_fecha` (
	...
	PRIMARY KEY (`id`),
	KEY `indicesFecha_tema` (`tema_id`),
	CONSTRAINT `indicesFecha_tema` FOREIGN KEY (`tema_id`) REFERENCES `nivel2_temas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nivel9_indices_lugar` (
	...
	PRIMARY KEY (`id`),
	UNIQUE KEY `indicesLugar_codigo` (`codigo`),
	KEY `indicesLugar_tema` (`tema_id`) USING BTREE,
	CONSTRAINT `indicesLugar_tema` FOREIGN KEY (`tema_id`) REFERENCES `nivel2_temas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `us_usuarios` (
	...
	KEY `usuarios_pais` (`pais_id`),
	KEY `usuarios_rol` (`rol_id`) USING BTREE,
	KEY `usuarios_statusRegistro` (`statusRegistro_id`) USING BTREE,
	CONSTRAINT `usuarios_pais` FOREIGN KEY (`pais_id`) REFERENCES `aux_paises` (`id`),
	CONSTRAINT `usuarios_rol` FOREIGN KEY (`rol_id`) REFERENCES `us_roles` (`id`),
	CONSTRAINT `usuarios_statusRegistro` FOREIGN KEY (`statusRegistro_id`) REFERENCES `us_status_registros` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `us_visitas` (
	...
	KEY `visitas_rol` (`rol_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
